...
var ItemDetailPage = /** @class */ (function () {
    ...
    ItemDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-item-detail',template:/*ion-inline-start:"C:\AndroidApp\ToDoApp\src\pages\item-detail\item-detail.html"*/'\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <ion-card>\n        <ion-card-content>\n            {{description}}\n        </ion-card-content>\n    </ion-card>\n</ion-content>\n'/*ion-inline-end:"C:\AndroidApp\ToDoApp\src\pages\item-detail\item-detail.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_detail_item_detail__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__add_item_add_item__ = __webpack_require__(99);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.ionViewDidLoad = function () {
        this.items = [
            { title: "Notatka 1", description: "Tekst notatki 1" },
            { title: "Notatka 2", description: "Tekst notatki 2" },
            { title: "Notatka 3", description: "Tekst notatki 3" }
        ];
    };
    HomePage.prototype.viewItem = function (item) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__item_detail_item_detail__["a" /* ItemDetailPage */], { item: item });
    };
    HomePage.prototype.addItem = function (items) {
        // this.navCtrl.push(AddItemPage, items);
        var _this = this;
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\AndroidApp\ToDoApp\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      Do zrobienia\n    </ion-title>\n      <ion-buttons end>\n          <button ion-button icon-only (click)="addItem(items)"><ion-icon name="add-circle"></ion-icon></button>\n      </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  \n    <ion-list>\n        <ion-item *ngFor="let item of items" (click)="viewItem(item)">\n            {{item.title}}\n        </ion-item>\n    </ion-list>\n    \n</ion-content>\n'/*ion-inline-end:"C:\AndroidApp\ToDoApp\src\pages\home\home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_item_detail_item_detail__ = __webpack_require__(100);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\AndroidApp\ToDoApp\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\AndroidApp\ToDoApp\src\app\app.html"*/
        }),
...
var AddItemPage = /** @class */ (function () {
    function AddItemPage(navCtrl, navParams, view) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.view = view;
    }
    /* ionViewDidLoad() {
           ...
           itemsArr = this.navParams.get('items');
    ...
    AddItemPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-add-item',template:/*ion-inline-start:"C:\AndroidApp\ToDoApp\src\pages\add-item\add-item.html"*/'\n<ion-header>\n\n  <ion-toolbar color="primary">\n    <ion-title>AddItem {{itemsArr}}</ion-title>\n      <ion-buttons end>\n        <button ion-button icon-only (click)="close()">\n            <ion-icon name="close"></ion-icon>\n          </button>\n      </ion-buttons>\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content>\n    \n    <ion-list>\n        <ion-item>\n            <ion-label floating>Tytuł</ion-label>\n            <ion-input type="text" [(ngModel)]="title"></ion-input>\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Opis</ion-label>\n            <ion-input type="text"  [(ngModel)]="description"></ion-input>\n        </ion-item>\n    </ion-list>\n    \n    <button ion-button full color="primary" (click)="saveItem()">Zapisz notatkę</button>\n\n</ion-content>\n'/*ion-inline-end:"C:\AndroidApp\ToDoApp\src\pages\add-item\add-item.html"*/,
        }),
